...
imagePath = 'E:\Acdemics\EBS CBE\21ES603 - Signal & Image Processing\Term Project\HEMORRHAGE\Hemorrhagic\6_0_61.jpg'
image = imread(imagePath);
image=imresize(image,[512,512])
% Convert the image to grayscale
grayImage = rgb2gray(image);
bw = im2bw(grayImage,0.6);
label=bwlabel(bw);
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
denoised_img = wiener2(label, [5, 5]); % Adjust the neighborhood size as needed
imshow(denoised_img);
...
tumorThreshold = 200; % Adjust the intensity threshold based on your specific case
...
subplot(1, 3, 3);
imshow(tumorMask, []);
title('Identified hemorrhage Region');
...
title('Overlay of Identified hemorrhage on Original Image');
